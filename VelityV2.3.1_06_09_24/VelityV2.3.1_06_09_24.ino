...
NexButton modeToggle1_PARKING = NexButton(4, 6, "ModeToggle1");  // ปุ่มที่หน้า page 4, ID 6
NexButton modeToggle2_RACING = NexButton(5, 6, "ModeToggle2");   // ปุ่มที่หน้า page 5, ID 6
NexNumber rpm2 = NexNumber(4, 7, "RPM");
NexNumber rpm1 = NexNumber(5, 7, "RPM");
NexNumber battery1 = NexNumber();
NexNumber battery2 = NexNumber();
